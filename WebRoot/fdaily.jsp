		...
		<div>
			...
			<ul>
				<s:iterator value="#session.dailyLists">
					<div>
						<li><s:property value="mesg" /> <s:if test="imgName==null">
								<a>无图片</a>
							</s:if> <s:else>
								<br>
								<img height="380px" width="380px"
									src="upload/<s:property value="imgName"/>"></img>
							</s:else></li>
					</div>
				</s:iterator>
			</ul>
			<br>
			<div id="page">
				<a href="showDailyAction?type=0&pageIndex=1">首页</a> <a
					href="showDailyAction?type=0&pageIndex=<s:property value='pageIndex-1'/>">上一页</a>
				<a
